...
import type { BarcodeScannerPlugin, ReadBarcodeFromBase64, IsGoogleBarcodeScannerModuleAvailableResult, IsSupportedResult, IsTorchAvailableResult, IsTorchEnabledResult, PermissionStatus, ReadBarcodesFromImageOptions, ReadBarcodesFromImageResult, ScanResult, StartScanOptions } from './definitions';
export declare class BarcodeScannerWeb extends WebPlugin implements BarcodeScannerPlugin {
    ...
    readBarcodeBase64(_options: ReadBarcodeFromBase64): Promise<ReadBarcodesFromImageResult>;
